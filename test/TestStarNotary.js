...
it("lets 2 users exchange stars", async () => {
  ...
  const starOwner = instance.ownerOf.call(starId1);

  assert.notEqual(starOwner, accounts[1]);
});
...
it("lets a user transfer a star", async () => {
  ...
  await instance.transferStar(accounts[2], starId, { from: user1 });

  // 3. Verify the star owner changed.
  const starOwner = instance.ownerOf.call(starId);
